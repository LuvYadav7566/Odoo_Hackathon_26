  ...
  return (
    <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
      ...
      <div style={sectionCard}>
        <h3 className="font-display" style={{ fontSize: '18px', fontWeight: '700', color: '#1E293B', marginBottom: '20px' }}>
          Where & When
        </h3>
        <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
          <div>
            <label style={labelStyle}>
              <MapPin style={{ width: '14px', height: '14px', color: 'var(--color-primary)' }} /> Destination
            </label>
            <input
              required
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
            <div>
              <label style={labelStyle}>
                <Calendar style={{ width: '14px', height: '14px', color: 'var(--color-primary)' }} /> Start Date
              </label>
              <input
                required
                type="date"
            ...
            <div>
              <label style={labelStyle}>
                <Calendar style={{ width: '14px', height: '14px', color: 'var(--color-primary)' }} /> End Date
              </label>
              <input
                required
                type="date"
      ...
      <div style={sectionCard}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '16px' }}>
          <div>
            <label style={labelStyle}>
              <DollarSign style={{ width: '14px', height: '14px', color: 'var(--color-tertiary)' }} /> Total Budget
            </label>
            <input
              required
              type="number"
          ...
          <div>
            <label style={labelStyle}>
              <Users style={{ width: '14px', height: '14px', color: 'var(--color-primary)' }} /> Travelers
            </label>
            <input
              required
              type="number"
            ...
            return (
              <div
                ...
                style={{
                  ...
                  background: isSelected ? 'var(--color-primary-container)' : '#FFFFFF',
                  textAlign: 'center',
                }}
              >
                <div style={{ fontSize: '24px', marginBottom: '8px' }}>{style.icon}</div>
                <div style={{ color: isSelected ? 'var(--color-primary)' : '#1E293B', fontWeight: '600', fontSize: '14px' }}>{style.title}</div>
      ...
      {/* Interests */}
      <div style={sectionCard}>
        <h3 className="font-display" style={{ fontSize: '18px', fontWeight: '700', color: '#1E293B', marginBottom: '16px' }}>
      ...
      <motion.button
        ...
        style={{
          ...
          boxShadow: '0 4px 14px rgba(30, 64, 175, 0.20)',
      ...
      <AnimatePresence>
        {loading && streamText && (
          ...
          >
            <p style={{ fontSize: '11px', fontWeight: 700, color: 'var(--color-primary)', marginBottom: '10px', textTransform: 'uppercase', letterSpacing: '0.06em' }}>
              ✨ AI is thinking…
            </p>
            <pre style={{
