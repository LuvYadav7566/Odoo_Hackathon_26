...
const DashboardPage = () => {
  ...
  const stats = [
    { label: 'Total Trips', value: trips.length, icon: Map, color: 'var(--color-primary)', bg: 'rgba(30, 64, 175, 0.06)', border: 'rgba(30, 64, 175, 0.15)' },
    { label: 'Ongoing', value: ongoing.length, icon: TrendingUp, color: 'var(--color-tertiary)', bg: 'rgba(13, 148, 136, 0.06)', border: 'rgba(13, 148, 136, 0.15)' },
    { label: 'Upcoming', value: upcoming.length, icon: Calendar, color: 'var(--color-secondary)', bg: 'rgba(71, 85, 105, 0.06)', border: 'rgba(71, 85, 105, 0.15)' },
  ];
    ...
    >
      ...
      <motion.div
        ...
        style={{
          ...
          background: 'linear-gradient(135deg, rgba(30, 64, 175, 0.04), rgba(13, 148, 136, 0.04))',
      ...
      >
        ...
        <motion.button whileTap={{ scale: 0.97 }} onClick={() => navigate('/ai-planner')}
          style={{
            ...
            border: 'none', cursor: 'pointer',
            boxShadow: '0 6px 18px rgba(30, 64, 175, 0.20)',
          }}
        >
          Try AI Planner →
        </motion.button>
