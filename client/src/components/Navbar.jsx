              ...
              return (
                <Link
                  ...
                  style={{
                    ...
                    color: isActive ? 'var(--color-primary)' : (isAiLink ? 'var(--color-tertiary)' : '#64748B'),
                  }}
                  onMouseEnter={e => { if (!isActive) e.currentTarget.style.color = isAiLink ? 'var(--color-tertiary)' : '#1E293B'; e.currentTarget.style.background = '#F1F5F9'; }}
                  onMouseLeave={e => { if (!isActive) e.currentTarget.style.color = isAiLink ? 'var(--color-tertiary)' : '#64748B'; e.currentTarget.style.background = 'transparent'; }}
                >
                  {isActive && (
                    <motion.span
